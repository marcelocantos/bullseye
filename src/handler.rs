...
fn next_top_level_id(
    ...
    // Short sequential T{n} over live ∪ git history (🎯T28). Cross-clone
    // uniqueness is not guaranteed (T51 scoped form backed out).
    crate::id_alloc::next_top_level_id(file, historical)
}
